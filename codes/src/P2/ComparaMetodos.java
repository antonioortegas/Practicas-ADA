...
public class ComparaMetodos {
	...
	public static void main(String[] args) {
		int[] tam = { 5, 10, 50, 100, 500, 1000, 2000, 5000, 10000 };//Selecciona tamaños de entrada
		int numPruebas = 500; //Selecciona número de pruebas por tamaño
		String[] competidores = { "N", "N2", "N3" }; //Selecciona orden de los algoritmos competidores
